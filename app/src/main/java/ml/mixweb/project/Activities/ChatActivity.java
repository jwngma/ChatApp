...
import ml.mixweb.project.Utils.GetTimeAgo;
import ml.mixweb.project.Adapters.MessageAdapter;
...
////
        ...
        mRootRef.child("Users").child(mChatUser).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(ChatActivity.this).load(image).placeholder(R.drawable.circle_small_image).into(mProfileImage);
        ...
        mChatAddBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivityForResult(Intent.createChooser(galleryIntent,"SELECT IAMGE"),GALLERY_PICK);
            }
        });
